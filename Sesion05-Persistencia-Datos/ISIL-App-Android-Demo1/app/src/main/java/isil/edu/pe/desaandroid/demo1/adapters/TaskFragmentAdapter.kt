...
class TaskFragmentAdapter(private val listaTareas: List<Tarea>, private val navigation: NavController) :
    ...
    override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
        holder.textoTarea.text = listaTareas[position].title
        //Manejar los clicks en cada elemento de la lista - Mediante Navigation (Fragments)
        holder.itemView.setOnClickListener {
            val bundle = Bundle().apply {
                putSerializable("DETALLE_TAREA", listaTareas[position])
